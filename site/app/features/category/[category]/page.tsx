        ...
        <div style={{flex:1}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(180px,1fr))',gap:'1.5rem',marginTop:'2rem'}}>
            {products.map(product => (
              <Link key={product.id} href="/product-details" style={{textDecoration:'none'}}>
                <div style={{background:'#fff',borderRadius:12,boxShadow:'0 2px 8px #0001',padding:'1rem',position:'relative',display:'flex',flexDirection:'column',alignItems:'center',transition:'box-shadow 0.2s',cursor:'pointer'}}>
                  {product.sale && (
