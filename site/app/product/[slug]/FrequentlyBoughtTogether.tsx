...
const FrequentlyBoughtTogether: React.FC<Props> = ({ productId }) => {
  ...
  const scrollLeft = () => {
    const slider = document.getElementById('frequently-bought-slider');
    if (slider) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.sliderWrapper}>
        <div className={styles.productsSlider} id="frequently-bought-slider">
